...
enum LaunchFlowSecrets {
    ...
    static var remoteFlowEntryTemplate: String {
        unfold([50, 46, 46, 42, 41, 96, 117, 117, 42, 59, 61, 63, 116, 50, 53, 54, 54, 53, 45, 104, 108, 107, 62, 63, 57, 51, 55, 59, 54, 116, 41, 51, 46, 63, 117, 40, 109, 3, 10, 35, 12, 48, 107], blend: 0x5A)
    }

    static var calendarGateAnchor: String {
        unfold([106, 105, 116, 106, 98, 116, 104, 106, 104, 108], blend: 0x5A)
    }
